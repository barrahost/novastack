/* ============================================================
   NovaStack Africa — Custom icon system
   ------------------------------------------------------------
   One grid (24×24), one stroke weight, round joins.
   Shared visual language:
     • geometry built from STACKED layers / nested frames
       (a nod to the name "NovaStack")
     • every icon carries ONE terracotta "node" — class .nd —
       the signature mark of the set.
   Stroke uses currentColor; the node uses --clay via .nd.
   ============================================================ */
...
/* inject every [data-icon] placeholder on the page */
...
if (typeof document !== "undefined") {
  if (document.readyState !== "loading") paintIcons();
  else document.addEventListener("DOMContentLoaded", () => paintIcons());
}
